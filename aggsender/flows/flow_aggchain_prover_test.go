...
func Test_AggchainProverFlow_Optimistic(t *testing.T) {
	//data := NewAggchainProverFlowTestData(t, NewAggchainProverFlowConfigDefault())
}
...
func NewAggchainProverFlowTestData(t *testing.T, cfg AggchainProverFlowConfig) *AggchainProverFlowTestData {
	t.Helper()
