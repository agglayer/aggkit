...
func TestGenerateAggchainProof_Success(t *testing.T) {
	...
	result, err := client.GenerateAggchainProof(100, 200, common.Hash{}, l1infotreesync.L1InfoTreeLeaf{}, [32]common.Hash{}, nil)
...
func TestGenerateAggchainProof_Error(t *testing.T) {
	...
	result, err := client.GenerateAggchainProof(300, 400, common.Hash{}, l1infotreesync.L1InfoTreeLeaf{}, [32]common.Hash{}, nil)
