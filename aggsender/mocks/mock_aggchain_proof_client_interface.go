...
import (
	grpc "github.com/agglayer/aggkit/aggsender/grpc"
...
func (_m *AggchainProofClientInterface) GenerateAggchainProof(req *grpc.AggchainProofRequest) (*types.AggchainProof, error) {
	ret := _m.Called(req)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*grpc.AggchainProofRequest) (*types.AggchainProof, error)); ok {
		return rf(req)
	}
	if rf, ok := ret.Get(0).(func(*grpc.AggchainProofRequest) *types.AggchainProof); ok {
		r0 = rf(req)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(*grpc.AggchainProofRequest) error); ok {
		r1 = rf(req)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *AggchainProofClientInterface_GenerateAggchainProof_Call) Run(run func(req *grpc.AggchainProofRequest)) *AggchainProofClientInterface_GenerateAggchainProof_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*grpc.AggchainProofRequest))
	})
	return _c
}
...
func (_c *AggchainProofClientInterface_GenerateAggchainProof_Call) RunAndReturn(run func(*grpc.AggchainProofRequest) (*types.AggchainProof, error)) *AggchainProofClientInterface_GenerateAggchainProof_Call {
	_c.Call.Return(run)
	return _c
}

// GenerateOptimisticAggchainProof provides a mock function with given fields: req, signature
func (_m *AggchainProofClientInterface) GenerateOptimisticAggchainProof(req *grpc.AggchainProofRequest, signature []byte) (*types.AggchainProof, error) {
	...
	var r0 *types.AggchainProof
	var r1 error
	if rf, ok := ret.Get(0).(func(*grpc.AggchainProofRequest, []byte) (*types.AggchainProof, error)); ok {
		return rf(req, signature)
	}
	if rf, ok := ret.Get(0).(func(*grpc.AggchainProofRequest, []byte) *types.AggchainProof); ok {
		r0 = rf(req, signature)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.AggchainProof)
	...
	if rf, ok := ret.Get(1).(func(*grpc.AggchainProofRequest, []byte) error); ok {
		r1 = rf(req, signature)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *AggchainProofClientInterface_GenerateOptimisticAggchainProof_Call) Run(run func(req *grpc.AggchainProofRequest, signature []byte)) *AggchainProofClientInterface_GenerateOptimisticAggchainProof_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*grpc.AggchainProofRequest), args[1].([]byte))
	})
	return _c
}
...
func (_c *AggchainProofClientInterface_GenerateOptimisticAggchainProof_Call) RunAndReturn(run func(*grpc.AggchainProofRequest, []byte) (*types.AggchainProof, error)) *AggchainProofClientInterface_GenerateOptimisticAggchainProof_Call {
	_c.Call.Return(run)
	return _c
}
