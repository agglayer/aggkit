...
func (_m *AggchainProofClientInterface) GenerateAggchainProof(startBlock uint64, maxEndBlock uint64, l1InfoTreeRootHash common.Hash, l1InfoTreeLeaf l1infotreesync.L1InfoTreeLeaf, l1InfoTreeMerkleProof types.Proof, gerLeaves map[common.Hash]*aggsendertypes.GerLeaf, importedBridgeExits []*agglayer.ImportedBridgeExit) (*aggsendertypes.AggchainProof, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(uint64, uint64, common.Hash, l1infotreesync.L1InfoTreeLeaf, types.Proof, map[common.Hash]*aggsendertypes.GerLeaf, []*agglayer.ImportedBridgeExit) (*aggsendertypes.AggchainProof, error)); ok {
		return rf(startBlock, maxEndBlock, l1InfoTreeRootHash, l1InfoTreeLeaf, l1InfoTreeMerkleProof, gerLeaves, importedBridgeExits)
	}
	if rf, ok := ret.Get(0).(func(uint64, uint64, common.Hash, l1infotreesync.L1InfoTreeLeaf, types.Proof, map[common.Hash]*aggsendertypes.GerLeaf, []*agglayer.ImportedBridgeExit) *aggsendertypes.AggchainProof); ok {
	...
	if rf, ok := ret.Get(1).(func(uint64, uint64, common.Hash, l1infotreesync.L1InfoTreeLeaf, types.Proof, map[common.Hash]*aggsendertypes.GerLeaf, []*agglayer.ImportedBridgeExit) error); ok {
...
//   - gerLeaves map[common.Hash]*aggsendertypes.GerLeaf
...
func (_c *AggchainProofClientInterface_GenerateAggchainProof_Call) Run(run func(startBlock uint64, maxEndBlock uint64, l1InfoTreeRootHash common.Hash, l1InfoTreeLeaf l1infotreesync.L1InfoTreeLeaf, l1InfoTreeMerkleProof types.Proof, gerLeaves map[common.Hash]*aggsendertypes.GerLeaf, importedBridgeExits []*agglayer.ImportedBridgeExit)) *AggchainProofClientInterface_GenerateAggchainProof_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(uint64), args[1].(uint64), args[2].(common.Hash), args[3].(l1infotreesync.L1InfoTreeLeaf), args[4].(types.Proof), args[5].(map[common.Hash]*aggsendertypes.GerLeaf), args[6].([]*agglayer.ImportedBridgeExit))
	})
	return _c
}
...
func (_c *AggchainProofClientInterface_GenerateAggchainProof_Call) RunAndReturn(run func(uint64, uint64, common.Hash, l1infotreesync.L1InfoTreeLeaf, types.Proof, map[common.Hash]*aggsendertypes.GerLeaf, []*agglayer.ImportedBridgeExit) (*aggsendertypes.AggchainProof, error)) *AggchainProofClientInterface_GenerateAggchainProof_Call {
	_c.Call.Return(run)
	return _c
}
