...
// L1InfoTreeDataQuerier provides a mock function with no fields
func (_m *AggsenderFlowBaser) L1InfoTreeDataQuerier() types.L1InfoTreeDataQuerier {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for L1InfoTreeDataQuerier")
	}

	var r0 types.L1InfoTreeDataQuerier
	if rf, ok := ret.Get(0).(func() types.L1InfoTreeDataQuerier); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(types.L1InfoTreeDataQuerier)
		}
	}
...
// AggsenderFlowBaser_L1InfoTreeDataQuerier_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'L1InfoTreeDataQuerier'
type AggsenderFlowBaser_L1InfoTreeDataQuerier_Call struct {
	*mock.Call
}

// L1InfoTreeDataQuerier is a helper method to define mock.On call
func (_e *AggsenderFlowBaser_Expecter) L1InfoTreeDataQuerier() *AggsenderFlowBaser_L1InfoTreeDataQuerier_Call {
	return &AggsenderFlowBaser_L1InfoTreeDataQuerier_Call{Call: _e.mock.On("L1InfoTreeDataQuerier")}
}

func (_c *AggsenderFlowBaser_L1InfoTreeDataQuerier_Call) Run(run func()) *AggsenderFlowBaser_L1InfoTreeDataQuerier_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *AggsenderFlowBaser_L1InfoTreeDataQuerier_Call) Return(_a0 types.L1InfoTreeDataQuerier) *AggsenderFlowBaser_L1InfoTreeDataQuerier_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *AggsenderFlowBaser_L1InfoTreeDataQuerier_Call) RunAndReturn(run func() types.L1InfoTreeDataQuerier) *AggsenderFlowBaser_L1InfoTreeDataQuerier_Call {
	_c.Call.Return(run)
	return _c
}

// L2BridgeQuerier provides a mock function with no fields
func (_m *AggsenderFlowBaser) L2BridgeQuerier() types.BridgeQuerier {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for L2BridgeQuerier")
	}

	var r0 types.BridgeQuerier
	if rf, ok := ret.Get(0).(func() types.BridgeQuerier); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(types.BridgeQuerier)
		}
	}
...
// AggsenderFlowBaser_L2BridgeQuerier_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'L2BridgeQuerier'
type AggsenderFlowBaser_L2BridgeQuerier_Call struct {
	*mock.Call
}

// L2BridgeQuerier is a helper method to define mock.On call
func (_e *AggsenderFlowBaser_Expecter) L2BridgeQuerier() *AggsenderFlowBaser_L2BridgeQuerier_Call {
	return &AggsenderFlowBaser_L2BridgeQuerier_Call{Call: _e.mock.On("L2BridgeQuerier")}
}

func (_c *AggsenderFlowBaser_L2BridgeQuerier_Call) Run(run func()) *AggsenderFlowBaser_L2BridgeQuerier_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *AggsenderFlowBaser_L2BridgeQuerier_Call) Return(_a0 types.BridgeQuerier) *AggsenderFlowBaser_L2BridgeQuerier_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *AggsenderFlowBaser_L2BridgeQuerier_Call) RunAndReturn(run func() types.BridgeQuerier) *AggsenderFlowBaser_L2BridgeQuerier_Call {
	_c.Call.Return(run)
	return _c
}
