...
// GetBridgesAndClaims provides a mock function with given fields: ctx, fromBlock, toBlock, certificateType
func (_m *BridgeQuerier) GetBridgesAndClaims(ctx context.Context, fromBlock uint64, toBlock uint64, certificateType types.CertificateType) ([]bridgesync.Bridge, []bridgesync.Claim, error) {
	ret := _m.Called(ctx, fromBlock, toBlock, certificateType)
	...
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64, uint64, types.CertificateType) ([]bridgesync.Bridge, []bridgesync.Claim, error)); ok {
		return rf(ctx, fromBlock, toBlock, certificateType)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint64, uint64, types.CertificateType) []bridgesync.Bridge); ok {
		r0 = rf(ctx, fromBlock, toBlock, certificateType)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, uint64, uint64, types.CertificateType) []bridgesync.Claim); ok {
		r1 = rf(ctx, fromBlock, toBlock, certificateType)
	} else {
		if ret.Get(1) != nil {
	...
	if rf, ok := ret.Get(2).(func(context.Context, uint64, uint64, types.CertificateType) error); ok {
		r2 = rf(ctx, fromBlock, toBlock, certificateType)
	} else {
		r2 = ret.Error(2)
	}
...
func (_e *BridgeQuerier_Expecter) GetBridgesAndClaims(ctx interface{}, fromBlock interface{}, toBlock interface{}, certificateType interface{}) *BridgeQuerier_GetBridgesAndClaims_Call {
	return &BridgeQuerier_GetBridgesAndClaims_Call{Call: _e.mock.On("GetBridgesAndClaims", ctx, fromBlock, toBlock, certificateType)}
}

func (_c *BridgeQuerier_GetBridgesAndClaims_Call) Run(run func(ctx context.Context, fromBlock uint64, toBlock uint64, certificateType types.CertificateType)) *BridgeQuerier_GetBridgesAndClaims_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uint64), args[2].(uint64), args[3].(types.CertificateType))
	})
	return _c
}
...
func (_c *BridgeQuerier_GetBridgesAndClaims_Call) RunAndReturn(run func(context.Context, uint64, uint64, types.CertificateType) ([]bridgesync.Bridge, []bridgesync.Claim, error)) *BridgeQuerier_GetBridgesAndClaims_Call {
	_c.Call.Return(run)
	return _c
}
