...
func (_m *BridgeQuerier) GetBridgesAndClaims(ctx context.Context, fromBlock uint64, toBlock uint64) ([]bridgesync.Bridge, []types.Claim, error) {
	...
	var r1 []types.Claim
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64, uint64) ([]bridgesync.Bridge, []types.Claim, error)); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, uint64, uint64) []types.Claim); ok {
		r1 = rf(ctx, fromBlock, toBlock)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).([]types.Claim)
		}
	}
...
func (_c *BridgeQuerier_GetBridgesAndClaims_Call) Return(_a0 []bridgesync.Bridge, _a1 []types.Claim, _a2 error) *BridgeQuerier_GetBridgesAndClaims_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *BridgeQuerier_GetBridgesAndClaims_Call) RunAndReturn(run func(context.Context, uint64, uint64) ([]bridgesync.Bridge, []types.Claim, error)) *BridgeQuerier_GetBridgesAndClaims_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *BridgeQuerier) GetLastProcessedBlock(ctx context.Context) (uint64, bool, error) {
	ret := _m.Called(ctx)
...
func (_c *BridgeQuerier_GetLastProcessedBlock_Call) Return(_a0 uint64, _a1 bool, _a2 error) *BridgeQuerier_GetLastProcessedBlock_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *BridgeQuerier_GetLastProcessedBlock_Call) RunAndReturn(run func(context.Context) (uint64, bool, error)) *BridgeQuerier_GetLastProcessedBlock_Call {
	_c.Call.Return(run)
	return _c
}

// GetUnsetClaimsForBlockRange provides a mock function with given fields: ctx, fromBlock, toBlock
func (_m *BridgeQuerier) GetUnsetClaimsForBlockRange(ctx context.Context, fromBlock uint64, toBlock uint64) ([]types.Unclaim, error) {
	ret := _m.Called(ctx, fromBlock, toBlock)
...
// BridgeQuerier_GetUnsetClaimsForBlockRange_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetUnsetClaimsForBlockRange'
type BridgeQuerier_GetUnsetClaimsForBlockRange_Call struct {
	*mock.Call
}
...
//   - fromBlock uint64
//   - toBlock uint64
func (_e *BridgeQuerier_Expecter) GetUnsetClaimsForBlockRange(ctx interface{}, fromBlock interface{}, toBlock interface{}) *BridgeQuerier_GetUnsetClaimsForBlockRange_Call {
	return &BridgeQuerier_GetUnsetClaimsForBlockRange_Call{Call: _e.mock.On("GetUnsetClaimsForBlockRange", ctx, fromBlock, toBlock)}
}

func (_c *BridgeQuerier_GetUnsetClaimsForBlockRange_Call) Run(run func(ctx context.Context, fromBlock uint64, toBlock uint64)) *BridgeQuerier_GetUnsetClaimsForBlockRange_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uint64), args[2].(uint64))
	})
	return _c
...
func (_c *BridgeQuerier_GetUnsetClaimsForBlockRange_Call) Return(_a0 []types.Unclaim, _a1 error) *BridgeQuerier_GetUnsetClaimsForBlockRange_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *BridgeQuerier_GetUnsetClaimsForBlockRange_Call) RunAndReturn(run func(context.Context, uint64, uint64) ([]types.Unclaim, error)) *BridgeQuerier_GetUnsetClaimsForBlockRange_Call {
	_c.Call.Return(run)
	return _c
}
