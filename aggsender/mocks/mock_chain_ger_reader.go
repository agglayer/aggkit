...
func (_m *ChainGERReader) GetInjectedGERsForRange(ctx context.Context, fromBlock uint64, toBlock uint64) (map[common.Hash]lastgersync.GlobalExitRootInfo, error) {
	...
	var r0 map[common.Hash]lastgersync.GlobalExitRootInfo
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64, uint64) (map[common.Hash]lastgersync.GlobalExitRootInfo, error)); ok {
		return rf(ctx, fromBlock, toBlock)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint64, uint64) map[common.Hash]lastgersync.GlobalExitRootInfo); ok {
		r0 = rf(ctx, fromBlock, toBlock)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[common.Hash]lastgersync.GlobalExitRootInfo)
		}
	}
...
func (_c *ChainGERReader_GetInjectedGERsForRange_Call) Return(_a0 map[common.Hash]lastgersync.GlobalExitRootInfo, _a1 error) *ChainGERReader_GetInjectedGERsForRange_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ChainGERReader_GetInjectedGERsForRange_Call) RunAndReturn(run func(context.Context, uint64, uint64) (map[common.Hash]lastgersync.GlobalExitRootInfo, error)) *ChainGERReader_GetInjectedGERsForRange_Call {
	_c.Call.Return(run)
	return _c
}
