...
func (_m *ChainGERReader) GetInjectedGERsForRange(ctx context.Context, fromBlock uint64, toBlock uint64) (map[common.Hash]l2gersync.GlobalExitRootInfo, error) {
	...
	var r0 map[common.Hash]l2gersync.GlobalExitRootInfo
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64, uint64) (map[common.Hash]l2gersync.GlobalExitRootInfo, error)); ok {
		return rf(ctx, fromBlock, toBlock)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint64, uint64) map[common.Hash]l2gersync.GlobalExitRootInfo); ok {
		r0 = rf(ctx, fromBlock, toBlock)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[common.Hash]l2gersync.GlobalExitRootInfo)
		}
	}
