...
func (_m *L2BridgeSyncer) CheckUnsetClaim(globalIndex *big.Int) (*bridgesync.UnsetClaim, error) {
...
// L2BridgeSyncer_CheckUnsetClaim_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CheckUnsetClaim'
type L2BridgeSyncer_CheckUnsetClaim_Call struct {
	*mock.Call
}

// CheckUnsetClaim is a helper method to define mock.On call
//   - globalIndex *big.Int
func (_e *L2BridgeSyncer_Expecter) CheckUnsetClaim(globalIndex interface{}) *L2BridgeSyncer_CheckUnsetClaim_Call {
	return &L2BridgeSyncer_CheckUnsetClaim_Call{Call: _e.mock.On("CheckUnsetClaim", globalIndex)}
}

func (_c *L2BridgeSyncer_CheckUnsetClaim_Call) Run(run func(globalIndex *big.Int)) *L2BridgeSyncer_CheckUnsetClaim_Call {
...
func (_c *L2BridgeSyncer_CheckUnsetClaim_Call) Return(_a0 *bridgesync.UnsetClaim, _a1 error) *L2BridgeSyncer_CheckUnsetClaim_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *L2BridgeSyncer_CheckUnsetClaim_Call) RunAndReturn(run func(*big.Int) (*bridgesync.UnsetClaim, error)) *L2BridgeSyncer_CheckUnsetClaim_Call {
	_c.Call.Return(run)
	return _c
}
