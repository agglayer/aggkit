...
func (_m *OptimisticAggregationProofPublicValuesQuerier) GetAggregationProofPublicValuesData(lastProvenBlock uint64, requestedEndBlock uint64, l1InfoTreeLeafHash common.Hash) (*types.AggregationProofPublicValues, error) {
...
func (_c *OptimisticAggregationProofPublicValuesQuerier_GetAggregationProofPublicValuesData_Call) Return(_a0 *types.AggregationProofPublicValues, _a1 error) *OptimisticAggregationProofPublicValuesQuerier_GetAggregationProofPublicValuesData_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *OptimisticAggregationProofPublicValuesQuerier_GetAggregationProofPublicValuesData_Call) RunAndReturn(run func(uint64, uint64, common.Hash) (*types.AggregationProofPublicValues, error)) *OptimisticAggregationProofPublicValuesQuerier_GetAggregationProofPublicValuesData_Call {
	_c.Call.Return(run)
	return _c
}
