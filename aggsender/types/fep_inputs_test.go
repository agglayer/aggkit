...
func TestAggchainParams_String(t *testing.T) {
	aggchainParams := &AggchainParams{
		AggregationProofPublicValues: AggregationProofPublicValues{
			L2PreRoot:           common.HexToHash("0x28f97583aa1d73ecd3838c2c1007e26f81aa522ab49d1b3731b48a4ba2ed918a"),
			ClaimRoot:           common.HexToHash("0xc6bc97efacff37a2a05adbe03c8a6f0fb0e322538744c4b7f53d784fff4abc3c"),
	...
	expected := "AggchainParamsValues{ l2_pre_root: 0x28f97583aa1d73ecd3838c2c1007e26f81aa522ab49d1b3731b48a4ba2ed918a" +
		" claim_root: 0xc6bc97efacff37a2a05adbe03c8a6f0fb0e322538744c4b7f53d784fff4abc3c" +
		" claim_block_number: 61" +
		" rollup_config_hash: 0xc6e1bc6dad7ad983e435b14924dd450024119cda78eebca10429019d1cb55fd3" +
		" optimistic_mode: false" +
		" trusted_signer_address: 0x5b06837A43bdC3dD9F114558DAf4B26ed49842Ed" +
		" range_v_key_commitment: 0x416d710344b6b6fa2a0b1a1445f3d6ba4fdd5ab43f0e863b1c522db20f28ad9b" +
		" aggregation_v_key_hash: 0x00afb45d8064ae10aa6a1793b8f39a24c27268efae2917b5c02950b2377fbf00" +
		"}"

	require.Equal(t, expected, aggchainParams.String())
}
