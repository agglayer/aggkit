...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/types.ClaimRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Claim is sponsored",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/sponsored-claim-status": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Global index of the claim (big.Int format)",
                        "name": "global_index",
                        "in": "query",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "Claim sponsorship status",
                        "schema": {
                            "type": "string"
                        }
                    },
    ...
    "definitions": {
        ...
        "types.ClaimRequest": {
            ...
            "properties": {
                "amount": {
                    "description": "Amount in wei (or token's smallest unit)",
                    "type": "string",
                    "example": "1000000000000000000"
                },
                "destination_address": {
                ...
                "destination_network": {
                    "description": "ID of the network where the claim is being sent",
                    "type": "integer",
                    "example": 100
                },
                "global_index": {
                    "description": "Global leaf index",
                    "type": "string",
                    "example": "123456789012345678901234567890"
                },
                "leaf_type": {
                    "description": "Type of leaf node (e.g., asset or message)",
                    "type": "integer",
                    "example": 1
                },
                "mainnet_exit_root": {
                    "description": "Mainnet exit root",
                    "type": "string",
                    "example": "0xabc123..."
                },
                "metadata": {
                    "description": "Optional metadata for the claim",
                    "type": "array",
                    "items": {
                        "type": "integer"
                    }
                ...
                "origin_network": {
                    "description": "Origin network ID where the claim originated",
                    "type": "integer",
                    "example": 1
                },
                ...
                "proof_local_exit_root": {
                    "description": "Merkle proof for local exit root",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "proof_rollup_exit_root": {
                    "description": "Merkle proof for rollup exit root",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
