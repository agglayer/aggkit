...
func (_m *Bridger) IsEmpty(ctx context.Context) (bool, error) {
	ret := _m.Called(ctx)
...
// Bridger_IsEmpty_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'IsEmpty'
type Bridger_IsEmpty_Call struct {
	*mock.Call
}

// IsEmpty is a helper method to define mock.On call
//   - ctx context.Context
func (_e *Bridger_Expecter) IsEmpty(ctx interface{}) *Bridger_IsEmpty_Call {
	return &Bridger_IsEmpty_Call{Call: _e.mock.On("IsEmpty", ctx)}
}

func (_c *Bridger_IsEmpty_Call) Run(run func(ctx context.Context)) *Bridger_IsEmpty_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *Bridger_IsEmpty_Call) Return(_a0 bool, _a1 error) *Bridger_IsEmpty_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Bridger_IsEmpty_Call) RunAndReturn(run func(context.Context) (bool, error)) *Bridger_IsEmpty_Call {
	_c.Call.Return(run)
	return _c
}

// GetDatabase provides a mock function with given fields:
func (_m *Bridger) GetDatabase() *sql.DB {
	ret := _m.Called()
...
// Bridger_GetDatabase_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetDatabase'
type Bridger_GetDatabase_Call struct {
	*mock.Call
}

// GetDatabase is a helper method to define mock.On call
func (_e *Bridger_Expecter) GetDatabase() *Bridger_GetDatabase_Call {
	return &Bridger_GetDatabase_Call{Call: _e.mock.On("GetDatabase")}
}

func (_c *Bridger_GetDatabase_Call) Run(run func()) *Bridger_GetDatabase_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *Bridger_GetDatabase_Call) Return(_a0 *sql.DB) *Bridger_GetDatabase_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Bridger_GetDatabase_Call) RunAndReturn(run func() *sql.DB) *Bridger_GetDatabase_Call {
	_c.Call.Return(run)
	return _c
}
