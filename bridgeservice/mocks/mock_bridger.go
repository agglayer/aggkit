...
// GetUnsetClaimsPaged provides a mock function with given fields: ctx, page, pageSize, networkIDs, globalIndex
func (_m *Bridger) GetUnsetClaimsPaged(ctx context.Context, page uint32, pageSize uint32, networkIDs []uint32, globalIndex *big.Int) ([]*bridgesync.UnsetClaim, int, error) {
	...
	var r1 int
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, uint32, uint32, []uint32, *big.Int) ([]*bridgesync.UnsetClaim, int, error)); ok {
		return rf(ctx, page, pageSize, networkIDs, globalIndex)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint32, uint32, []uint32, *big.Int) []*bridgesync.UnsetClaim); ok {
...
//   - networkIDs []uint32
//   - globalIndex *big.Int
func (_e *Bridger_Expecter) GetUnsetClaimsPaged(ctx interface{}, page interface{}, pageSize interface{}, networkIDs interface{}, globalIndex interface{}) *Bridger_GetUnsetClaimsPaged_Call {
	return &Bridger_GetUnsetClaimsPaged_Call{Call: _e.mock.On("GetUnsetClaimsPaged", ctx, page, pageSize, networkIDs, globalIndex)}
}

func (_c *Bridger_GetUnsetClaimsPaged_Call) Run(run func(ctx context.Context, page uint32, pageSize uint32, networkIDs []uint32, globalIndex *big.Int)) *Bridger_GetUnsetClaimsPaged_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Bridger_GetUnsetClaimsPaged_Call) RunAndReturn(run func(context.Context, uint32, uint32, []uint32, *big.Int) ([]*bridgesync.UnsetClaim, int, error)) *Bridger_GetUnsetClaimsPaged_Call {
	_c.Call.Return(run)
	return _c
}
