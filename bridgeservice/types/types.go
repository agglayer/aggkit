...
// @Description Contains synchronization information for both L1 and L2 networks including deposit counts and sync status
// @example {"l1_info":{"contract_deposit_count":100,"bridge_deposit_count":100,"is_synced":true},"l2_info":{"contract_deposit_count":200,"bridge_deposit_count":200,"is_synced":true}}
...
// @Description Contains network-specific synchronization information including contract and bridge deposit counts and sync status
