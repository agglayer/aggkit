...
func TestBackwardLETEvent_CombinedBridgeAndRootDeletion(t *testing.T) {
	...
	var (
		...
		storedPreviousRootStr          string
		storedNewDepositCount          string
		storedNewRootStr               string
	)
	err = rows.Scan(&storedBlockNum, &storedBlockPos, &storedPreviousDepositCount, &storedPreviousRootStr, &storedNewDepositCount, &storedNewRootStr)
	require.NoError(t, err)
	...
	require.Equal(t, backwardLET.PreviousRoot.Hex(), storedPreviousRootStr)
	require.Equal(t, backwardLET.NewDepositCount.String(), storedNewDepositCount)
	require.Equal(t, backwardLET.NewRoot.Hex(), storedNewRootStr)
