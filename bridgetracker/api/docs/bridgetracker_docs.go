...
const docTemplatebridgetracker = `{
    ...
    "definitions": {
        ...
        "types.CacheInfo": {
            ...
            "properties": {
                "kind": {
                    "description": "Kind is CacheKindMemory or CacheKindDisk",
                    "type": "string"
                },
                "size_bytes": {
                    "description": "SizeBytes is the on-disk size of the SQLite database, in bytes. Omitted when Kind is\nCacheKindMemory, which has no disk footprint to report",
                    "type": "integer"
                }
            }
        },
...
// SwaggerInfobridgetracker holds exported Swagger Info so clients can modify it
var SwaggerInfobridgetracker = &swag.Spec{
	Version:          "1.0",
	Host:             "",
	BasePath:         "/tracker/v1",
	Schemes:          []string{},
	...
	InfoInstanceName: "bridgetracker",
	SwaggerTemplate:  docTemplatebridgetracker,
	LeftDelim:        "{{",
	RightDelim:       "}}",
}

func init() {
	swag.Register(SwaggerInfobridgetracker.InstanceName(), SwaggerInfobridgetracker)
}
