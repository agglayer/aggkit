...
The validator is configured using a `.toml` file. Check the default values in this link: https://github.com/agglayer/aggkit/blob/develop/config/default.go
