...
func (_m *RollupManagerContract) RollupIDToRollupData(opts *bind.CallOpts, rollupID uint32) (agglayermanager.AgglayerManagerRollupDataReturn, error) {
...
func (_c *RollupManagerContract_RollupIDToRollupData_Call) Return(_a0 agglayermanager.AgglayerManagerRollupDataReturn, _a1 error) *RollupManagerContract_RollupIDToRollupData_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *RollupManagerContract_RollupIDToRollupData_Call) RunAndReturn(run func(*bind.CallOpts, uint32) (agglayermanager.AgglayerManagerRollupDataReturn, error)) *RollupManagerContract_RollupIDToRollupData_Call {
	_c.Call.Return(run)
	return _c
}
