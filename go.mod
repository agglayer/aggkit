...
require (
	buf.build/gen/go/agglayer/agglayer/grpc/go v1.6.1-20260408162430-f39b589db9b4.1
	buf.build/gen/go/agglayer/agglayer/protocolbuffers/go v1.36.11-20260408162430-f39b589db9b4.1
	buf.build/gen/go/agglayer/interop/protocolbuffers/go v1.36.11-00000000000000-29048f73ad53.1
