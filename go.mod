...
require (
	github.com/0xPolygonHermez/zkevm-data-streamer v0.2.6 // indirect
	github.com/0xPolygonHermez/zkevm-ethtx-manager v0.1.10-0.20240716105056-c051c96d0234 // indirect
