...
require (
	...
	buf.build/gen/go/agglayer/interop/protocolbuffers/go v1.36.10-20250519093743-85e8a3d9f59c.1
	buf.build/gen/go/agglayer/provers/grpc/go v1.5.1-20250520163122-7efa0a2f81a8.2
	buf.build/gen/go/agglayer/provers/protocolbuffers/go v1.36.10-20250520163122-7efa0a2f81a8.1
