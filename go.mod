...
require (
	buf.build/gen/go/agglayer/agglayer/grpc/go v1.6.1-20260313083409-67f1062dbaa3.1
	buf.build/gen/go/agglayer/agglayer/protocolbuffers/go v1.36.11-20260313083409-67f1062dbaa3.1
