...
func (s *L2GERSync) GetRemoveGEREventsByBlockRange(ctx context.Context, fromBlock, toBlock uint64) ([]*RemoveGEREvent, error) {
...
func (s *L2GERSync) GetRemoveGEREventsByGER(ctx context.Context, globalExitRoot common.Hash) ([]*RemoveGEREvent, error) {
