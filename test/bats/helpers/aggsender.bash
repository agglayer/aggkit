...
function wait_to_settled_certificate_containing_global_index() {
    ...
    run_with_timeout "wait certificate settle for $_global_index" $_check_frequency $_timeout $aggsender_find_imported_bridge $_aggkit_pp1_node_url $_global_index
}
