...
@test "L1 to L2" {
    ...
    echo "=== Running LxLy bridge eth L1($l1_rpc_url) to L2(PP1) amount:$amount" >&3
    ...
    timeout="200" 
    claim_frequency="60"
    echo "=== Running LxLy claim L2($l2_rpc_url) bridge_api: $bridge_api_url for: $bridge_tx_hash" >&3
