...
docker run --rm -v $(pwd):/contracts ethereum/solc:0.8.18-alpine - /contracts/bridgeeventimpostor/BridgeEventImpostor.sol -o /contracts --abi --bin --overwrite --optimize --via-ir
mv -f BridgeEventImpostor.abi abi/bridgeeventimpostor.abi
mv -f BridgeEventImpostor.bin bin/bridgeeventimpostor.bin
