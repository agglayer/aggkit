...
| Field | Why |
| ----- | --- |
| `l1RpcUrl` | Your L1 JSON-RPC endpoint. Required by Step E and Step I — without it the certificate will be incomplete. Use a **Sepolia** RPC for `zkevm-cardona.json` and an **Ethereum mainnet** RPC for `zkevm-mainnet.json`. |
