...
func (_m *RPCClienter) BatchCallContext(ctx context.Context, b []rpc.BatchElem) error {
	ret := _m.Called(ctx, b)
...
// RPCClienter_BatchCallContext_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'BatchCallContext'
type RPCClienter_BatchCallContext_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - b []rpc.BatchElem
func (_e *RPCClienter_Expecter) BatchCallContext(ctx interface{}, b interface{}) *RPCClienter_BatchCallContext_Call {
	return &RPCClienter_BatchCallContext_Call{Call: _e.mock.On("BatchCallContext", ctx, b)}
}

func (_c *RPCClienter_BatchCallContext_Call) Run(run func(ctx context.Context, b []rpc.BatchElem)) *RPCClienter_BatchCallContext_Call {
...
func (_c *RPCClienter_BatchCallContext_Call) Return(_a0 error) *RPCClienter_BatchCallContext_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *RPCClienter_BatchCallContext_Call) RunAndReturn(run func(context.Context, []rpc.BatchElem) error) *RPCClienter_BatchCallContext_Call {
	_c.Call.Return(run)
	return _c
}
